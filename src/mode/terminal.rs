    ...
    SIZE: TerminalDisplaySize,
{
    ...
    fn char_to_bitmap(input: char) -> [u8; 8] {
        const CHARS: [[u8; 8]; 95] = [
            ...
            // 1
            [0x00, 0x22, 0x21, 0x3f, 0x20, 0x20, 0x20, 0x00],
            // 2
            [0x00, 0x32, 0x29, 0x29, 0x29, 0x29, 0x26, 0x00],
            // 3
            [0x00, 0x12, 0x21, 0x21, 0x25, 0x25, 0x1a, 0x00],
            // 4
            ...
            // 7
            [0x00, 0x01, 0x01, 0x31, 0x09, 0x05, 0x03, 0x00],
            // 8
            ...
            // A
            [0x00, 0x3e, 0x09, 0x09, 0x09, 0x09, 0x3e, 0x00],
            // B
            [0x00, 0x3f, 0x25, 0x25, 0x25, 0x25, 0x1a, 0x00],
            // C
            [0x00, 0x1e, 0x21, 0x21, 0x21, 0x21, 0x12, 0x00],
            // D
            [0x00, 0x3f, 0x21, 0x21, 0x21, 0x12, 0x0c, 0x00],
            // E
            [0x00, 0x3f, 0x25, 0x25, 0x25, 0x25, 0x21, 0x00],
            // F
            [0x00, 0x3f, 0x05, 0x05, 0x05, 0x05, 0x01, 0x00],
            // G
            [0x00, 0x1e, 0x21, 0x21, 0x21, 0x29, 0x1a, 0x00],
            // H
            [0x00, 0x3f, 0x04, 0x04, 0x04, 0x04, 0x3f, 0x00],
            // I
            [0x00, 0x21, 0x21, 0x3f, 0x21, 0x21, 0x00, 0x00],
            // J
            [0x00, 0x10, 0x20, 0x20, 0x20, 0x20, 0x1f, 0x00],
            // K
            [0x00, 0x3f, 0x04, 0x0c, 0x0a, 0x11, 0x20, 0x00],
            // L
            [0x00, 0x3f, 0x20, 0x20, 0x20, 0x20, 0x20, 0x00],
            // M
            [0x00, 0x3f, 0x02, 0x04, 0x04, 0x02, 0x3f, 0x00],
            // N
            [0x00, 0x3f, 0x02, 0x04, 0x08, 0x10, 0x3f, 0x00],
            // O
            [0x00, 0x1e, 0x21, 0x21, 0x21, 0x21, 0x1e, 0x00],
            // P
            [0x00, 0x3f, 0x09, 0x09, 0x09, 0x09, 0x06, 0x00],
            // Q
            [0x00, 0x1e, 0x21, 0x29, 0x31, 0x21, 0x5e, 0x00],
            // R
            [0x00, 0x3f, 0x09, 0x09, 0x09, 0x19, 0x26, 0x00],
            // S
            [0x00, 0x12, 0x25, 0x25, 0x25, 0x25, 0x18, 0x00],
            // T
            [0x00, 0x01, 0x01, 0x01, 0x3f, 0x01, 0x01, 0x00],
            // U
            [0x00, 0x1f, 0x20, 0x20, 0x20, 0x20, 0x1f, 0x00],
            // V
            [0x00, 0x0f, 0x10, 0x20, 0x20, 0x10, 0x0f, 0x00],
            // W
            [0x00, 0x1f, 0x20, 0x10, 0x10, 0x20, 0x1f, 0x00],
            // X
            ...
            // a
            [0x00, 0x10, 0x2a, 0x2a, 0x2a, 0x3c, 0x00, 0x00],
            // b
            ...
            // e
            [0x00, 0x1c, 0x2a, 0x2a, 0x2a, 0x24, 0x00, 0x00],
            // f
            [0x00, 0x00, 0x3e, 0x05, 0x01, 0x00, 0x00, 0x00],
            // g
            [0x00, 0x18, 0xa4, 0xa4, 0xa4, 0x7c, 0x00, 0x00],
            // h
            [0x00, 0x3f, 0x04, 0x04, 0x04, 0x38, 0x00, 0x00],
            // i
            [0x00, 0x00, 0x24, 0x3d, 0x20, 0x00, 0x00, 0x00],
            // j
            [0x00, 0x20, 0x40, 0x40, 0x3d, 0x00, 0x00, 0x00],
            // k
            [0x00, 0x3f, 0x0c, 0x12, 0x20, 0x00, 0x00, 0x00],
            // l
            [0x00, 0x1f, 0x20, 0x20, 0x00, 0x00, 0x00, 0x00],
            // m
            [0x00, 0x3e, 0x02, 0x3c, 0x02, 0x3c, 0x00, 0x00],
            // n
            [0x00, 0x3e, 0x02, 0x02, 0x02, 0x3c, 0x00, 0x00],
            // o
            ...
            // r
            [0x00, 0x3e, 0x04, 0x02, 0x02, 0x00, 0x00, 0x00],
            // s
            [0x00, 0x24, 0x2a, 0x2a, 0x2a, 0x10, 0x00, 0x00],
            // t
            [0x00, 0x02, 0x1f, 0x22, 0x20, 0x00, 0x00, 0x00],
            // u
            [0x00, 0x1e, 0x20, 0x20, 0x20, 0x1e, 0x00, 0x00],
            // v
            [0x00, 0x06, 0x18, 0x20, 0x18, 0x06, 0x00, 0x00],
            // w
            [0x00, 0x1e, 0x30, 0x1c, 0x30, 0x1e, 0x00, 0x00],
            // x
